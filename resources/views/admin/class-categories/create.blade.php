        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title text-left"> Create main category </h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{route('main-categories.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 @if($errors->has('name')) has-danger @endif">
                                ...
                                <input id="name" class="form-control" placeholder="Main category name"
                                       name="name"
                        ...
                        <div class="form-row">
                            <div class="col ml-auto mr-auto text-right">
                                <a href="{{ route('main-categories.index') }}" class="btn"> Cancel </a>
