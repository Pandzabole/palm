            ...
            <div class="b-footer_column col-md-12 col-sm-12">
                <div class="b-footer_block">
                    <div class="b-footer_block_in">
                        <p class="text-center mb-0"><img src="{{ asset('front-css/assets/images/logo-white.png') }}" class="d-block m-auto img-fluid" alt="" title=""></p>
            ...
            <div class="b-footer_column col-lg-4 col-md-12 col-sm-12 mb-4">
                <div class="b-footer_block">
                    ...
                    <div class="b-footer_block_in">
                        ...
                        <br>
                        <p><img src="{{ asset('front-css/assets/images/payments.png') }}" alt=""></p>
                    </div>
                </div>
            </div>
        </aside>
